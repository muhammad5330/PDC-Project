...
$k{=}10$ clients). With sufficient local training ($E{=}3$), FedEx-LoRA
recovers up to \textbf{3.7\%} accuracy over FedAvg-LoRA on SST-2 and closes
94\% of the gap to centralised LoRA. We further characterise
synchronisation-frequency effects---demonstrating that $E{=}3$ local epochs
is optimal (64.1\% accuracy vs.\ 49.1\% for $E{=}1$)---and propose a novel
...
$\epsilon=0.559$ and persists at $\epsilon=0.244$ by round 5; FedEx-LoRA
...
\hline
1 & 0.5590 & $3.12\times10^{-5}$ \\
2 & 0.4785 & $3.12\times10^{-5}$ \\
3 & 0.3516 & $3.12\times10^{-5}$ \\
4 & 0.2974 & $3.12\times10^{-5}$ \\
5 & 0.2440 & $3.12\times10^{-5}$ \\
\hline
\end{tabular}
\end{center}
\end{table}
...
$E$ (0.350 at $E{=}1$ vs.\ 1.138 at $E{=}5$ by round 3), confirming that more
...
achieves the best final result (64.11\%) while $E{=}1$ underfits (49.08\%)
and $E{=}5$ exhibits client-drift oscillation (62.04\%). Table~\ref{tab:epochs}
...
\begin{enumerate}
  ...
  \item Residual norm grows monotonically with local epochs ($E$):
        $0.350$ at $E{=}1$ to $1.138$ at $E{=}5$, validating the PDC
        synchronisation-communication tradeoff. $E{=}3$ is optimal (64.11\%
        vs.\ 49.08\% for $E{=}1$ and 62.04\% for $E{=}5$).
